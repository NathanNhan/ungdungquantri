...
const Xuat_Danh_sach = (ds) => {
    ...
    ds.forEach((item, index) => {
        ...
        <tr>
            ...
            <td>
                <a href="javaScript:void(0)" data-toggle="modal" data-target="#modelId" title='Sửa Điện thoại' onclick="updateTivi('${item.Ma_so}')">
                    <i class="fa fa-pencil-square-o text-danger" aria-hidden="true"></i>
                </a>
            </td>
            <td>
                <a href="javaScript:void(0)" onclick="deleteTivi('${item.Ma_so}')" title='Xóa Điện thoại'>
